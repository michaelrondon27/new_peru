										...
										'<div class="dtp-date hidden">' +
											'<div>' +
												'<div class="left center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-month-before animated fadeInRight"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>' +
												'</div>' +
												'<div class="dtp-actual-month p80">MAR</div>' +
												'<div class="right center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-month-after animated fadeInleft"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>' +
												'</div>' +
												'<div class="clearfix"></div>' +
											'</div>' +
											...
											'<div>' +
												'<div class="left center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-year-before animated fadeInRight"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>' +
												'</div>' +
												'<div class="dtp-actual-year p80">2014</div>' +
												'<div class="right center p10">' +
													'<a href="javascript:void(0);" class="dtp-select-year-after animated fadeInLeft"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>' +
												'</div>' +
												'<div class="clearfix"></div>' +
											'</div>' +
										'</div>' +
