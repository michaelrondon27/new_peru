...
<html>
    ...
    ?>
        ...
        <div class="panel-body">
          <div class="col-md-9">
            <p class="animated fadeInDown">
             	Alumnos Inscritos <span class="fa-angle-right fa"></span> Consulta
            </p>
          </div>
          <div class="col-md-3">
            <p class="animated fadeInDown">
      ...
      <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
          <div class="panel">
           	<div class="panel-heading"><h3>Alumnos Inscritos</h3></div>
         		<div class="panel-body">
                ...
                <div id="resultados">
                  <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                    	<td colspan="10" style="text-align: center;">Seleccione las opciones de arriba.</td>
                    </tbody>
                  </table>
                </div>
              </div>
