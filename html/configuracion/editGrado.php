			...
			if(isset($_GET['error'])){
				if($_GET['error']==1){
					...
					?>
						<script>
							swal(
								{title:'Este grado ya se encuentra agregado en el sistema!',
								type:'error',
								confirmButtonText:'Aceptar'}
							);
						</script>
			                ...
			                <div class="panel-body">
			                    <div class="col-md-9">
			                        <p class="animated fadeInDown">
			                          	Configuración <span class="fa-angle-right fa"></span> Editar Grado <span class="fa-angle-right fa"></span> <?php echo $_grado[$_GET['id']]['grado'];?>
			                        </p>
			                    </div>
			                    <div class="col-md-3">
			                        <p class="animated fadeInDown">
			            ...
			            <div class="col-md-6 col-md-offset-2">
			                <div class="col-md-12 panel">
			                    ...
			                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
			                    	...
			                    	<br>
			                      	<div class="col-md-12">
			                        	<form class="cmxform" id="form_grado" method="post" action="?view=config&mode=EditGrado&id=<?php echo $_GET['id'];?>">
			                          		<div class="col-md-12">
			                            		<div class="form-group form-animate-text col-md-12" style="margin-top: -10px !important;">
			                              			<input type="text" class="form-text" name="grado" id="grado" required value="<?php echo $_grado[$_GET['id']]['grado'];?>">
			                              			<span class="bar"></span>
			                              			<label>*Grado:</label>
			                            		</div>
			                            		<div class="col-md-12">
