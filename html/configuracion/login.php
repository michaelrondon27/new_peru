			                ...
			                <div class="panel-body">
			                    <div class="col-md-9">
			                        <p class="animated fadeInDown">
			                          	Configuración <span class="fa-angle-right fa"></span> Editar Inicio de Sesión
			                        </p>
			                    </div>
			                </div>
			            </div>
						<div class="col-md-10">
			                <div class="col-md-10 col-md-offset-2 panel">
			                    <div class="col-md-12 panel-heading">
			                      	<h4>Editar Inicio de Sesión</h4>
			                    </div>
			                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
			                    	<p>Los campos con (*) son obligatorios.</p>
			                    	<br>
			                      	<div class="col-md-12">
			                        	<form class="cmxform" id="menu" method="post" action="?view=config&mode=Inicio" enctype="multipart/form-data">
			                          		<div class="col-md-12">
			                            		<div class="form-group form-animate-text col-md-12 col-sm-12" style="margin-top:0px !important;">
			                              			<input type="text" class="form-text" id="nombre" name="nombre" required value="<?php echo $_menu[2]['nombre'];?>">
			                              			<span class="bar"></span>
			                              			<label>*Nombre</label>
			                            		</div>
			                            		<div class="form-group form-animate-text col-md-2 col-sm-12" style="margin-top:0px !important;">
				          							<img src="asset/images/<?php echo $_menu[2]['logo'];?>"/ style="width: 100px;">
			                            		</div>
