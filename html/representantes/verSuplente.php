	                ...
	                <div class="panel-body">
	                    <div class="col-md-9">
	                        <p class="animated fadeInDown">
	                          	Representantes <span class="fa-angle-right fa"></span> Información del Represente Suplente <span class="fa-angle-right fa"></span> <?php echo $_suplente[$_GET['id']]['nombres']." ".$_suplente[$_GET['id']]['apellidos'];?>
	                        </p>
	                    </div>
	                    <div class="col-md-3">
	                        <p class="animated fadeInDown">
	                          <a class="btn btn-teal" href="?view=representante&mode=AllSuplente">Consultar Represente Suplente <i class="fa fa-sign-in" aria-hidden="true"></i></a>
	                        </p>
	                    </div>
	                </div>
	            </div>
                        ...
                        <div class="col-md-12 tabs-area">
			                <ul id="tabs-demo6" class="nav nav-tabs nav-tabs-v6" role="tablist">
              					...
              					<li role="presentation">
                					<a href="#tabs-demo7-area3" id="tabs-demo6-3" role="tab" data-toggle="tab" aria-expanded="false">Representado(s)</a>
              					</li>
              					<!--<li role="presentation" class="">
						                    ...
						                    <div class="panel">
						                   		<div class="panel-body">
						                    		<div class="responsive-table" style="color: #000; font-size: 16px;">
						                    			<div class="col-md-3">
						                    				Nombres: <?php echo $_suplente[$_GET['id']]['nombres'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Apellidos: <?php echo $_suplente[$_GET['id']]['apellidos'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Cédula: <?php echo $_suplente[$_GET['id']]['cedula'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Parentesco: <?php echo $_suplente[$_GET['id']]['parentesco'];?>
						                    			</div>
						                    			<br><br>
						                    			<div class="col-md-3">
						                    				Edad: <?php echo $_suplente[$_GET['id']]['edad'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Ocupación: <?php echo $_suplente[$_GET['id']]['ocupacion'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Grado de Instrucción: <?php echo $_instruccion[$_suplente[$_GET['id']]['id_instruccion']]['instruccion'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Tlf. Local: <?php echo $_local[$_suplente[$_GET['id']]['id_tlf_local']]['cod_tlf_local']."-".$_suplente[$_GET['id']]['tlf_hab'];?>
						                    			</div>
						                    			<br><br>
						                    			<div class="col-md-3">
						                    				Tlf. Celular: <?php echo $_celular[$_suplente[$_GET['id']]['id_tlf_cel']]['cod_tlf_cel']."-".$_suplente[$_GET['id']]['tlf_cel'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Correo: <?php echo $_suplente[$_GET['id']]['correo'];?>
						                    			</div>
						                    			<div class="col-md-6">
						                    				Direccion: <?php echo $_suplente[$_GET['id']]['dir_hab'];?>
						                    			</div>
						                    		</div>
						                  		</div>
						                	</div>
	                					...
	                					<div class="col-md-12">
	                    					<div class="panel">
	                   							<div class="panel-body">
	                    							<div class="responsive-table" style="color: #000; font-size: 16px;">
						                    			<div class="col-md-12">
						                    				Nombre y Dirección: <?php echo $_suplente[$_GET['id']]['dir_emp'];?>
						                    			</div>
						                    			<br><br>
						                    			<div class="col-md-12">
						                    				Teléfono de la empresa: <?php echo $_suplente[$_GET['id']]['cod_emp']."-".$_suplente[$_GET['id']]['tlf_emp'];?>
						                    			</div>
						                    		</div>
	                  							</div>
	                						</div>
						                    			...
						                    			<table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
						                    				<thead>
						                    					...
						                    					<?php
							                    					$db=new Conexion();
							                    					$id=$_GET['id'];
							                    					$sql=$db->query("SELECT cedula, nombres, apellidos, fec_nac, estudiante, id_alum FROM alumnos WHERE id_repre_sup=$id ORDER BY cedula;");
							                    					if($db->rows($sql)>0){
							                    						?>
																			<tbody>
							                    								<?php
