	                ...
	                <div class="panel-body">
	                    <div class="col-md-9">
	                        <p class="animated fadeInDown">
	                          	Representantes <span class="fa-angle-right fa"></span> Información del Representante Legal <span class="fa-angle-right fa"></span> <?php echo $_legal[$_GET['id']]['nombres']." ".$_legal[$_GET['id']]['apellidos'];?>
	                        </p>
	                    </div>
	                    <div class="col-md-3">
	                        <p class="animated fadeInDown">
						                    ...
						                    <div class="panel">
						                   		<div class="panel-body">
						                    		<div class="responsive-table" style="color: #000; font-size: 16px;">
						                    			<div class="col-md-3">
						                    				Nombres: <?php echo $_legal[$_GET['id']]['nombres'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Apellidos: <?php echo $_legal[$_GET['id']]['apellidos'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Cédula: <?php echo $_legal[$_GET['id']]['cedula'];?>
						                    			</div>
						                    			<div class="col-md-3">
						                    				Edad: <?php echo $_legal[$_GET['id']]['edad'];?>
						                    			</div>
						                    		</div>
						                  		</div>
						                	</div>
	                					...
	                					<div class="col-md-12">
	                    					<div class="panel">
	                   							<div class="panel-body">
	                    							<div class="responsive-table" style="color: #000; font-size: 16px;">
						                    			<div class="col-md-12">
						                    				Nombre y Dirección: <?php echo $_legal[$_GET['id']]['dir_empresa'];?>
						                    			</div>
						                    			<br><br>
						                    			<div class="col-md-12">
						                    				Teléfono de la empresa: <?php echo $_legal[$_GET['id']]['cod_emp']."-".$_legal[$_GET['id']]['tlf_empresa'];?>
						                    			</div>
						                    		</div>
	                  							</div>
	                						</div>
						                    			...
						                    			<table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
						                    				<thead>
						                    					...
						                    					<?php
							                    					$db=new Conexion();
							                    					$id=$_GET['id'];
							                    					$sql=$db->query("SELECT cedula, nombres, apellidos, fec_nac, estudiante, id_alum FROM alumnos WHERE id_repre=$id ORDER BY cedula;");
							                    					if($db->rows($sql)>0){
							                    						?>
																			<tbody>
							                    								<?php
